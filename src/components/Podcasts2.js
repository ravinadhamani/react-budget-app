...
export default function Podcasts2()
{
    ...
    return(
        ...
        <div className={styles.mainPodcastDiv}>            
            ...
            <button className={styles.season2}>Season 2</button>
            <div className={styles.gridContainer}>
                <div className={styles.gridItem}>
                    <h3>Season2 MybudgetApp Way</h3>
                ...
                <div className={styles.gridItem}>
                    <h3>Season2 Getting $40K into debt by </h3>
                ...
                <div className={styles.gridItem}>
                    <h3>Season2 A Financial Wakeup Call For Finance</h3>
